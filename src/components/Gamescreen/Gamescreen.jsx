...
const Gamescreen = ({score, setScore, currentMovie, setScreen, currentRound}) => {
    ...
    return (
        <div className='flex flex-col justify-center items-center gap-5 border-1 rounded-2xl w-[500px] h-[500px] p-4 drop-shadow-[0_0_10px_purple] bg-gradient-to-br from-black to-transparent to-100% '>
            <h1>{timeleft}</h1>
            ...
            <div className='relative w-[320px] h-[180px] rounded-2xl'>
                <img className='absolute w-full h-full object-cover rounded-2xl' src={currentMovie.movie_image} alt="" />
