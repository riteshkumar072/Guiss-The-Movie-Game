...
const Incorrect = ({currentMovie, nextRound, currentRound}) => {
  return (
    <div className='border-2 border-red-600 bg-gradient-to-br from-black via-305% to-transparent to-350%  w-[500px] h-[500px] rounded-2xl p-4 drop-shadow-[0_0_5px_rgba(255,0,0,1)] flex flex-col justify-center items-center gap-5'>
        ...
        <div className='flex gap-15 m-5 '>
            <img className='w-[150px] h-[200px] border border-white rounded-xl' src={currentMovie.poster} alt="" />
            <div className='flex flex-col h-[200px]'>
                <p className='text-white'>Correct answer is</p>
                <h2 className='text-red-600 font-bold text-2xl'>{currentMovie.movie_name}</h2>
                <p className='text-gray-600 font-bold'>{currentMovie.release_year}</p>
