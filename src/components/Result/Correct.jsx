...
const Correct = ({currentMovie, currentRound, nextRound}) => {
  return (
    <div className='border-2 border-green-600 bg-black w-[500px] h-[500px] rounded-2xl p-4 drop-shadow-[0_0_5px_rgba(0,255,0,1)] flex flex-col justify-center items-center gap-5'>
        ...
        <div className='flex gap-15 m-5 '>
            <img className='w-[150px] h-[200px] border border-white' key={currentMovie.id} src="{currentMovie.movie_image}" alt="" />
