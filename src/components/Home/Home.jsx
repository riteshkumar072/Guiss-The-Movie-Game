...
const Home = ({startGame}) => {
  return (
    <div className='border-2 rounded-2xl border-purple-500/20 bg-gradient-to-br from-[#180829] to-transparent to-1000% h-[500px] w-[500px] flex flex-col justify-center items-center'>
